...
<BODY>
<form id="theForm" name='theForm' method='post' action="corporate.htm?action=saveProtype" encType="multipart/form-data">
<div class="pwnav">
	<ul class="pwcon">
		<li >
		...
		<li>
			<span>外部地址：</span><input type="text" id="outurl" maxlength="100" name="outurl" value="${outurl}" style="width:300px;"/><span style="color:red;margin-left:10px;">(输入的地址必须为http://开头)</span>
		</li>
