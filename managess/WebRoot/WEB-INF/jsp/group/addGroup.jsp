...
<div class="pwnav">
	<ul class="pwcon">
		<li >
			<span>群组名称：</span><input type="text" class="text" id="groupname" maxlength="16" name=""groupname"" value="${name}"/></li>
		<li >
			<span class="pwcon_span">备&nbsp;&nbsp;&nbsp;&nbsp;注：</span><textarea id="memo" Cols='35' rows='5' maxlength=200 name="remark" onkeypress='doKeypress()' onkeydown='doKeydown()' onbeforepaste='doBeforePaste()' onpaste='doPaste()'>${remark}</textarea>
		</li>
		<li>
...
function doSave(groupname,memo){//index为搜索开始位置，len为每页显示的长度
	var pars ="groupname="+groupname+"&memo="+memo;
