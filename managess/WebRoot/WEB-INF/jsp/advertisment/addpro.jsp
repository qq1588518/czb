...
<BODY>
<form id="theForm" name='theForm' method='post' action="advertis.htm?action=saveProtype" encType="multipart/form-data">
<div class="pwnav">
	<ul class="pwcon">
		<li >
			<span>广告名称：</span><input type="text" class="text" id="namep" maxlength="30" name="name_product" value="${name}"/></li>
		<!--li >
		...
		<li >
			<span>广告图片：</span><input class="file"  id="read_pic"  type="file" name="picproduct" style="width:300px;"/><input id="pic" name="pic_addr" type="hidden" value="${pic}"/>
			<span style="color:red;padding-left:60px;">（上传160*60像素，大小不超过50K）</span>
