...
public class MobilTrainActivity extends CommonNew {

	private String path = MyURL.IP+ "/ssczb/index.htm?m=1011" +MyURL.UESER + MyURL.SYSTEM;
	@Override
