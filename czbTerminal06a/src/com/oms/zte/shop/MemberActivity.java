...
public class MemberActivity extends CommonNew{
	
	private String path = "http://wapsystem.yofoto.com.cn/index.aspx?m=1013"+MyURL.UESER+MyURL.SYSTEM;
	 @Override
