...
public class ViewToolsCultureActivity extends CommonNew {

	String path = MyURL.IP + "/ssczb/distributionurl.htm?action=companyCulture"+MyURL.UESER + MyURL.SYSTEM;
